...
namespace System.Data.Entity.SqlServer
{
    ...
    public sealed class SqlProviderServices : DbProviderServices
    {
        ...
        /// <summary>
        /// Set this flag to false to use an OUTPUT clause instead of the SCOPE_IDENTITY() function to 
        /// retrieve values generated on the database for numeric columns during an INSERT operation. 
        /// This makes it possible to retrieve values generated by sequences or other means, but setting 
        /// the flag to the default value of true is recommended and can provide better performance if all 
        /// values are generated using IDENTITY columns.
        /// </summary>
